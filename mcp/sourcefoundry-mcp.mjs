  ...
  tools: [
    {
      ...
      description: 'Create or update a durable, recurring supply of neutral source candidates. SourceFoundry operates collection; the consuming agent owns interpretation and output.',
      inputSchema: {
        type: 'object',
        properties: {
          ...
          name: { type: 'string' },
          purpose: { type: 'string', description: 'What material should be supplied, without asking SourceFoundry to write the final answer.' },
          sources: {
    ...
    },
    {
      ...
      description: 'Read neutral candidates from a SourceFoundry feed, optionally with source and run health evidence.',
      inputSchema: {
        type: 'object',
        properties: {
